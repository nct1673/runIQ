...
def load_one(db: Session, user_id: uuid.UUID, fields: dict) -> Activity:
    ...
    activity = Activity(
        ...
        raw_imported_at=fields.get("raw_imported_at"),
        activity_name=fields.get("activity_name"),
        event_type=fields.get("event_type"),
        elapsed_duration_s=fields.get("elapsed_duration_s"),
        moving_duration_s=fields.get("moving_duration_s"),
        calories=fields.get("calories"),
        avg_power=fields.get("avg_power"),
        norm_power=fields.get("norm_power"),
        avg_stride_length=fields.get("avg_stride_length"),
        avg_vertical_oscillation=fields.get("avg_vertical_oscillation"),
        avg_vertical_ratio=fields.get("avg_vertical_ratio"),
        avg_ground_contact_time=fields.get("avg_ground_contact_time"),
        start_latitude=fields.get("start_latitude"),
        start_longitude=fields.get("start_longitude"),
        training_effect_label=fields.get("training_effect_label"),
        vo2_max=fields.get("vo2_max"),
        hr_time_in_zone_1=fields.get("hr_time_in_zone_1"),
        hr_time_in_zone_2=fields.get("hr_time_in_zone_2"),
        hr_time_in_zone_3=fields.get("hr_time_in_zone_3"),
        hr_time_in_zone_4=fields.get("hr_time_in_zone_4"),
        hr_time_in_zone_5=fields.get("hr_time_in_zone_5"),
        power_time_in_zone_1=fields.get("power_time_in_zone_1"),
        power_time_in_zone_2=fields.get("power_time_in_zone_2"),
        power_time_in_zone_3=fields.get("power_time_in_zone_3"),
        power_time_in_zone_4=fields.get("power_time_in_zone_4"),
        power_time_in_zone_5=fields.get("power_time_in_zone_5"),
